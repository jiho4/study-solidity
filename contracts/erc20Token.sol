...
contract ERC20Token is ERC20Interface {
    ...
    function transferFrom(address _from, address _to, uint256 _value) public override  returns (bool success) {
        uint256 fundAllowance = allowed[_from][msg.sender];
        require(balances[_from] >= _value && fundAllowance >= _value,"Insufficient allowed funds for transfer source.");
        balances[_to] += _value;
        balances[_from] -= _value;
        if (fundAllowance < MAX_UINT256) {
